...
class SurveillanceEngine:
    def __int__(self, traget_embedding, threshold=0.6, skip_frames=2):
        self.target_embedding = self.target_embedding
    ...
    def process_video(self, video_source, output_path=None):
        ...
        processor = VideoProcessor(video_source) # type: ignore
        matches = []
